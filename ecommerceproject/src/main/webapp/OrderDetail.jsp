...
<script>
	...
	function updateTotalPrice() {
		...
		var total = 0;
		var subtotalCells = document
				.getElementsByClassName("shoping__cart__total");
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="Home">Home</a> <span>Order Detail</span>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="shoping__cart__table">
							<table>
								...
								<tbody>
									...
									<td>${order.shippingSuburb}</td>
									<td>${order.shippingState}</td>
									<td>${order.totalAmount}</td> --%>

										<tr>
											<td class="shoping__cart__price"><a href="">${order.orderItemId}</a></td>
											<td class="shoping__cart__price"><a href="">${order.productId}</a></td>
											...
											<td class="shoping__cart__price"><a href="">${order.quantity}</a></td>
											<td class="shoping__cart__quantity">$${order.price}</td>

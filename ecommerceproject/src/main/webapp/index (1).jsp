...
<!-- 							<li><a href="./contact.html">Contact</a></li> -->
				...
				<div class="col-lg-9">
					<div class="hero__search">
						<div class="hero__search__form">
							<form action="Home1?command=SEARCH">
								<div class="hero__search__categories">
									All Categories <span class="arrow_carrot-down"> </span>

								</div> 
								<input name="Command" hidden=true value="SEARCH"></input>
								<input type="text" placeholder="What do yo u need?" name="keyword" value ="${keyword}">
	...
	<section class="categories">
		<div class="container">
			...
			<div>
			<c:if test="${not empty productListBySearch }">
				<ul>
			...
			<c:if test="${empty productListBySearch }">
				Not found products, please try again
			</c:if>
	...
	<div class="pagination">
		<c:forEach var="pageNumber" begin ="1" end ="${totalPage}">
          <a href ="Home1?Command=PAGE & page=${pageNumber}">${pageNumber}</a>
      </c:forEach>
	</div>
	</div>	
	</section>
